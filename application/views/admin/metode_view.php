      ...
      <table id="myTable" class="table table-hover">
        <thead>
          <tr>
            ...
            <th>
              <?=anchor('admin/metode_bayar/tambah_metode/',
              'Tambah',
        ...
        <tbody>
          ...
          <tr>
              <td><?php echo $no++ ?></td>
              <td><?php echo $metod->id_bayar; ?></td>
              <td><?php echo $metod->nm_bayar; ?></td>
              <td><?php echo $metod->an; ?></td>
              <td><?php echo $metod->norek; ?></td>
              <td>
                <?=anchor('admin/metode_bayar/update_metode/'.$metod->id_bayar,
                'Edit',
