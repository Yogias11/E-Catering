      ...
      <table id="myTable" class="table table-hover">
        <thead>
          <tr>
            ...
            <th>Level</th>            
            <th>
              <?=anchor('admin/Pelanggan/tambah_user',
              'Tambah',
        ...
        <tbody>
          ...
          <tr>
              ...
              <td><?php echo $users->ponsel; ?></td>
              <td><?php echo $users->password; ?></td>
              <td><?php echo $users->level; ?></td>
              <td>
                <?=anchor('admin/Pelanggan/update_user/'.$users->id_user,
                'Ubah',
                ['class'=>'btn btn-info btn-sm'])?>
                <?=anchor('admin/Pelanggan/delete_user/'.$users->id_user,
                'Hapus',
