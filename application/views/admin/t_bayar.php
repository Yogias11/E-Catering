...
<div class="container-fluid">
  <div class="row content">
    ...
    <?= form_open_multipart ('admin/metode_bayar/tambah_metode',['class'=>'form-horizontal']); ?> 
        <div class="form-group">
          <label for="inputPassword3" class="col-sm-2 control-label">Kode Metode</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" name="id_bayar" placeholder="" value="<?= $kode;?>" readonly>
          </div>
        </div>
        <div class="form-group">
          <label for="inputPassword3" class="col-sm-2 control-label">Nama Bank</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" name="nm_bayar" placeholder="" value="<?= set_value('nm_bayar')?>">
          </div>
        </div>
        <div class="form-group">
          <label for="inputPassword3" class="col-sm-2 control-label">Atas Nama</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" name="an" placeholder="" value="<?= set_value('an')?>">
          </div>
        </div>
        <div class="form-group">
          <label for="inputPassword3" class="col-sm-2 control-label">No Rekening</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" name="norek" placeholder="" value="<?= set_value('norek')?>">
          </div>
        </div>
        <div class="form-group">
