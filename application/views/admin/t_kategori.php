...
<div class="container-fluid">
  <div class="row content">
    ...
    <?= form_open_multipart ('admin/Kategori/tambah_kategori',['class'=>'form-horizontal']); ?> 
        <div class="form-group">
          <label for="inputPassword3" class="col-sm-2 control-label">Nama Kategori</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" name="nama_kategori" placeholder="" value="<?= set_value('nama_kategori')?>">
          </div>
        </div>
        <div class="form-group">
