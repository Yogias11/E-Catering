    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="shopping"><img src="<?php echo base_url()?>assets/aa.png"></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="<?php echo base_url()?>"><i class="glyphicon glyphicon-home"></i> Home</a></li>
        <?php if($this->session->userdata('username')) { ?>
            <li><a href="<?php echo base_url()?>Customer/shopping_history"><i class="glyphicon glyphicon-credit-card"></i> Transaksi</a>  </li>
            <li><a href="<?php echo base_url()?>Customer/his"><i class="glyphicon glyphicon-briefcase"></i> Histori</a>
        <?php } ?>
            <li><a href="<?php echo base_url()?>shopping/tampil_cart"><i class="glyphicon glyphicon-shopping-cart"></i>  Keranjang Belanja</a></li>
        <?php if($this->session->userdata('username')) { ?>
            <li><div style="line-height:50px;"><i class="glyphicon glyphicon-user"></i> <?=$this->session->userdata('username')?></div></li>
            <li><?php echo anchor('logout', 'Logout'); ?></li>
        <?php }else{ ?>
            <li><?php echo anchor('login/login', 'Login'); ?></li>
            <?php } ?>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
